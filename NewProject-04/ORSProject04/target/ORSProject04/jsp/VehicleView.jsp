<%@page import="com.sunilos.p4.ctl.VehicleCtl"%>
...
<jsp:useBean id="bean" class="com.sunilos.p4.bean.VehicleBean"
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div class="card-body px-4 py-4">
			...
			<form action="<%=ORSView.VEHICLE_CTL%>" method="POST">
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Vehicle No <span
						class="text-danger">*</span></label> <input type="text" name="vehicleNo"
						class="form-control" maxlength="100"
						value="<%=DataUtility.getStringData(bean.getVehicleNo())%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("vehicleNo", request)%></div>
				</div>
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Model<span
						class="text-danger">*</span></label> <input type="text" name="model" 
						class="form-control" maxlength="200"
						value="<%=DataUtility.getStringData(bean.getModel())%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("model", request)%></div>
				</div>

				<div class="mb-3">
					<label class="form-label fw-semibold">Color <span
						class="text-danger">*</span></label> <input type="text" name="color"
						class="form-control" maxlength="200"
						value="<%=DataUtility.getStringData(bean.getColor())%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("color", request)%></div>
				</div>
				...
				<div class="d-flex gap-2 pt-2 border-top">
					...
					<a href="VehicleCtl" class="btn btn-secondary ms-auto"> <i
