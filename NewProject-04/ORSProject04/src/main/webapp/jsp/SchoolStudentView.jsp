<%@page import="com.sunilos.p4.ctl.SchoolStudentCtl"%>
<%@page import="com.sunilos.p4.ctl.BaseCtl"%>
<%@page import="com.sunilos.p4.ctl.ORSView"%>
<%@page import="com.sunilos.p4.util.DataUtility"%>
<%@page import="com.sunilos.p4.util.ServletUtility"%>
<%@page import="java.util.List"%>
<%@page import="com.sunilos.p4.bean.SchoolStudentBean"%>

<jsp:useBean id="bean" class="com.sunilos.p4.bean.SchoolStudentBean"
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div class="card-header text-white border-0 py-3 px-4"
			...
			<h5 class="mb-0 fw-bold">
				...
				<%=bean.getId() > 0 ? "Edit School Student" : "Add School Student"%>
			</h5>
		</div>
		...
		<div class="card-body px-4 py-4">
			...
			<form action="<%=ORSView.SCHOOLSTUDENT_CTL%>" method="POST">
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Course <span
						class="text-danger">*</span></label> <input type="text" name="course" 
						class="form-control" maxlength="200"
						value="<%=DataUtility.getStringData(bean.getCourse())%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("course", request)%></div>
				</div>
				...
				<div class="d-flex gap-2 pt-2 border-top">
					...
					<a href="SchoolStudentCtl" class="btn btn-secondary ms-auto"> <i
