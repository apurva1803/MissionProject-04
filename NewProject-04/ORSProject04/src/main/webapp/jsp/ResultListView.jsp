	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div
			...
			<h5 class="mb-0 fw-bold">
				<i class="bi bi-cart me-2"></i> Result List
			</h5>
			<div class="d-flex gap-2">
				...
				</a> <a href="<%=ORSView.RESULT_CTL%>"
					class="btn btn-sm btn-light text-primary fw-semibold"> <i
					class="bi bi-cart me-1"></i> Add Result
				</a>
			</div>
		</div>
				...
				<table class="table table-hover align-middle mb-0">
					...
					<tbody>
						...
						<tr>
							...
							<td class="fw-semibold"><%=bean.getStudentId()%></td>
							<td><%=bean.getPercentage()%></td>
							<td><%=bean.getGrade()%></td>
							<td><%=bean.getStatus()%></td>
							<td><a href="ResultCtl?id=<%=bean.getId()%>"
