...
Iterator<SchoolStudentBean> it = list.iterator();
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div
			...
			<h5 class="mb-0 fw-bold">
				<i class="bi bi-cart me-2"></i> School Student List
			</h5>
			<div class="d-flex gap-2">
				...
				</a> <a href="<%=ORSView.SCHOOLSTUDENT_CTL%>"
					class="btn btn-sm btn-light text-primary fw-semibold"> <i
					class="bi bi-cart me-1"></i> Add School Student
				</a>
			</div>
		</div>

		<form action="<%=ORSView.SCHOOLSTUDENT_LIST_CTL%>" method="POST">
			...
			<div class="table-responsive">
				<table class="table table-hover align-middle mb-0">
					...
					<tbody>
						<%
						while (it.hasNext()) {
							SchoolStudentBean bean = it.next();
						%>
						<tr>
							...
							<td><a href="SchoolStudentCtl?id=<%=bean.getId()%>"
