<%@page import="com.sunilos.p4.ctl.FaceRecognitionCtl"%>
...
<div class="container py-4" style="max-width: 580px;">
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div class="card-body px-4 py-4">
			...
			<form action="<%=ORSView.FACERECOGNITION_CTL%>" method="POST">
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Image Path <span
						class="text-danger">*</span></label> <input type="text" name="imagePath"
						class="form-control" maxlength="200"
						value="<%=DataUtility.getStringData(bean.getImagePath())%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("imagePath", request)%></div>
				</div>
				...
				<div class="d-flex gap-2 pt-2 border-top">
					...
					<a href="FaceRecognitionCtl" class="btn btn-secondary ms-auto"> <i
