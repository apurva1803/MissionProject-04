	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div class="card-body px-4 py-4">
			...
			<form action="<%=ORSView.SMARTPARKING_CTL%>" method="POST">
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Parking Code <span
						class="text-danger">*</span></label> <input type="text" name="parkingCode"
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Vehicle Number<span
						class="text-danger">*</span></label> <input type="text" name="vehicleNumber" 
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Slot Number<span
						class="text-danger">*</span></label> <input type="text" name="slotNumber" 
						class="form-control" maxlength="200"
				...
				<div class="d-flex gap-2 pt-2 border-top">
					...
					<a href="SmartParkingCtl" class="btn btn-secondary ms-auto"> <i
