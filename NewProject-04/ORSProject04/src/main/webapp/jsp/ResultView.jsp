<%@page import="com.sunilos.p4.ctl.ResultCtl"%>
<%@page import="com.sunilos.p4.ctl.BaseCtl"%>
<%@page import="com.sunilos.p4.ctl.ORSView"%>
<%@page import="com.sunilos.p4.util.DataUtility"%>
<%@page import="com.sunilos.p4.util.ServletUtility"%>
<%@page import="java.util.List"%>
<%@page import="com.sunilos.p4.bean.ResultBean"%>

<jsp:useBean id="bean" class="com.sunilos.p4.bean.ResultBean"
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div class="card-header text-white border-0 py-3 px-4"
			...
			<h5 class="mb-0 fw-bold">
				...
				<%=bean.getId() > 0 ? "Edit Result" : "Add Result"%>
			</h5>
		</div>
		...
		<div class="card-body px-4 py-4">
			...
			<form action="<%=ORSView.RESULT_CTL%>" method="POST">
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">percentage<span
						class="text-danger">*</span></label> <input type="text" name="percentage" 
						class="form-control" maxlength="200"
						value="<%=DataUtility.getStringData(bean.getPercentage())%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("percentage", request)%></div>
				</div>

				<div class="mb-3">
					<label class="form-label fw-semibold">grade<span
						class="text-danger">*</span></label> <input type="text" name="grade" 
						class="form-control" maxlength="200"
						value="<%=DataUtility.getStringData(bean.getGrade())%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("grade", request)%></div>
				</div>
				...
				<div class="d-flex gap-2 pt-2 border-top">
					...
					<a href="ResultCtl" class="btn btn-secondary ms-auto"> <i
