	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div
			...
			<h5 class="mb-0 fw-bold">
				<i class="bi bi-cart me-2"></i> Face Recognition List
			</h5>
			<div class="d-flex gap-2">
				...
				</a> <a href="<%=ORSView.FACERECOGNITION_CTL%>"
					class="btn btn-sm btn-light text-primary fw-semibold"> <i
					class="bi bi-cart me-1"></i> Add Face Recognition
				</a>
			</div>
		</div>

		<form action="<%=ORSView.FACERECOGNITION_LIST_CTL%>" method="POST">
