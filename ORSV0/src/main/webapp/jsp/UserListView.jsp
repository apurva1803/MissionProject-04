...
<div class="container-fluid px-4 py-4" style="max-width:1000px;">
  <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
    ...
    <div class="card-header text-white border-0 py-3 px-4 d-flex justify-content-between align-items-center"
      ...
      <h5 class="mb-0 fw-bold"><i class="bi bi-people-fill me-2"></i> User List</h5>
      <div class="d-flex gap-2">
        <a href="<%=ORSView.USER_REPORT_CTL%>" target="_blank" class="btn btn-sm btn-warning fw-semibold">
          <i class="bi bi-file-earmark-pdf me-1"></i> Print PDF
        </a>
        <a href="<%=ORSView.USER_REPORT_CTL%>?type=doc" target="_blank" class="btn btn-sm btn-info fw-semibold">
          <i class="bi bi-file-earmark-word me-1"></i> Print DOC
        </a>
        <a href="UserCtl" class="btn btn-sm btn-light text-primary fw-semibold">
    ...
    <form action="<%=ORSView.USER_LIST_CTL%>" method="POST">
      ...
      <div class="p-3 bg-light border-bottom d-flex flex-wrap gap-2 align-items-center">
        <input type="text" name="firstName" class="form-control form-control-sm" style="max-width:180px;"
               placeholder="First Name" value="<%=ServletUtility.getParameter("firstName", request)%>">
        <input type="text" name="login" class="form-control form-control-sm" style="max-width:200px;"
        ...
        <table class="table table-hover align-middle mb-0">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="UserCtl?id=<%=bean.getId()%>" class="btn btn-sm btn-outline-primary">
